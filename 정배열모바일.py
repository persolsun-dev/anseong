...
def check_password():
  def password_entered():
    # 👇 "안성도서관1234" 부분을 원하시는 비밀번호로 변경하세요!
...
# ---------------------------------------------------------
# 3. Streamlit 모바일 웹 UI 구성 (인증 완료 후 표시)
# ---------------------------------------------------------
...
if target_image is not None:
  ...
  st.image(target_image, caption="촬영된 서가 이미지", use_container_width=True)
  ...
  st.info(
      "OCR 인식 특성상 오인식된 글자가 있을 수 있습니다. 아래 텍스트 상자에서 직접"
      " 수정 후 점검을 실행하세요."
  )
